...
void setup_s460_07()
{
 ...
 /*
  ...
  //238U for s460
  frs->bfield[0] = 13.343;//                 Please do NOT comment-out old brho and add new brho. Please make a NEW setup file. 
  frs->bfield[1] = 11.9095;//                 Please do NOT comment-out old brho and add new brho. Please make a NEW setup file. 
  frs->bfield[2] = 10.063; //                 Please do NOT comment-out old brho and add new brho. Please make a NEW setup file. 
  frs->bfield[3] = 10.063; //                 Please do NOT comment-out old brho and add new brho. Please make a NEW setup file. 
