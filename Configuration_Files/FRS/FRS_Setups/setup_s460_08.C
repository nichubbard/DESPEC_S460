...
void setup_s460_08()
{
 ...
 /*
  ...
  frs->dist_TPC24 = 3985.0; //measured on 2020/Feb/20 s46
  ...
  frs->bfield[1] = 12.4040;//                 Please do NOT comment-out old brho and add new brho. Please make a NEW setup file. 
  frs->bfield[2] = 10.7471; //                 Please do NOT comment-out old brho and add new brho. Please make a NEW setup file. 
  frs->bfield[3] = 10.7471; //                 Please do NOT comment-out old brho and add new brho. Please make a NEW setup file. 
