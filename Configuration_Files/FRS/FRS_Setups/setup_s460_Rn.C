...
//   }
 ...
 /*
  ...
  //238U for s460, Rn
  frs->bfield[0] = 13.1510;//                 Please do NOT comment-out old brho and add new brho. Please make a NEW setup file. 
  frs->bfield[1] = 13.1510;//                 Please do NOT comment-out old brho and add new brho. Please make a NEW setup file. 
  frs->bfield[2] = 11.0279; //                 Please do NOT comment-out old brho and add new brho. Please make a NEW setup file. 
  frs->bfield[3] = 11.0279; //                 Please do NOT comment-out old brho and add new brho. Please make a NEW setup file. 
...
// TOF calibration SC21-SC81 (TAC)
  ...
  id->offset_z2  = 0.0 ;
  id->offset_z3  = 0.0 ;
  id->a2AoQCorr = 0.0018;//011504; //0.0012; //2020April12 JP
  id->a4AoQCorr = 0.010;
