...
//         hSCI_Tof3 = MakeH1I(fname,name,1000,0,62000,"TAC SC42-SC21 [ps] (pos.corr.)",2,3);
    ...
    h_VFTX_AoQ2241 = MakeTH1('D',"FRS/VFTX/ID/ID_Z1_2241_AoQ_vftx", " VFTX A/Q 22->41",1500,FRS_MIN_AoQ,FRS_MAX_AoQ, "A/Q s2-s4");
  ...
  //   hID_Z = MakeH1I("ID",Form("ID_Z, gain=%f",music->e1_gain[0]),1000,10,93,"Z s2-s4",2,6);
    ...
    hID_Z_2241_vftx = MakeTH1('D',"FRS/VFTX/ID/ID_Z_2241_vftx","ID_Z1",1000,FRS_MIN_Z,FRS_MAX_Z,"Z1 s2-s4");
...
//     htpc_Y4 = MakeTH1('D',"FRS/TPC/S4_TPCY","tpc_y S41",800,-100,100);
  ...
  //  hMUSIC1_MUSIC2 = MakeTH2('D',"FRS/MUSIC/MUSIC1_MUSIC2","dE1_dE2", 1024,0,4096,1024,0,4096);  
   ...
   hvftx_ToFraw_2241LL = (TH1D*)MakeTH1('D',"FRS/VFTXSCI/ToFraw_2241LL","ToFraw_41-22_mult1_LL",20000,-20000.,230000,"ToFraw [10ps] ");
   
   hvftx_ToFraw_2241RR = (TH1D*)MakeTH1('D',"FRS/VFTXSCI/ToFraw_2241RR","ToFraw_41-22_mult1_RR",20000,-20000.,230000,"ToFraw [10ps] ");
...
//     hts2 = MakeTH1('D',"FRS/ts2","ts2",30,0.,300.);
  ...
  void EventUnpackProc::Fill_FRS_Histos(int PrcID, int Type, int SubType){
   ...
   // ID_z3 = RAW->get_FRS_z3();
    ...
    FRS_vftx_beta_2141 = RAW->get_FRS_vftx_beta_2141(); 
    FRS_gamma_2141 = RAW->get_FRS_gamma_2141();
    FRS_aoq_2141 = RAW->get_FRS_aoq_2141();
    FRS_aoq_2141_corr = RAW->get_FRS_aoq_2141_corr();
    FRS_2141_z = RAW->get_FRS_2141_z();
    FRS_2141_v_cor = RAW->get_FRS_2141_v_cor();
    FRS_beta_2241 = RAW->get_FRS_beta_2241();
    FRS_gamma_2241 = RAW->get_FRS_gamma_2241();
    FRS_aoq_2241 = RAW->get_FRS_aoq_2241();
    FRS_aoq_2241_corr = RAW->get_FRS_aoq_2241_corr();
    FRS_2241_z = RAW->get_FRS_2241_z();
    FRS_2241_v_cor = RAW->get_FRS_2241_v_cor();
...
//           h_VFTX_beta2141  ->Fill(id_vftx_beta_2141*1000.);
	h_VFTX_AoQ2141   ->Fill(FRS_aoq_2141);
	h_VFTX_AoQ2141corr   ->Fill(FRS_aoq_2141_corr);
// //     h_VFTX_x2AoQ2141  ->Fill(id_vftx_aoq_2141, id_x2);
//      h_VFTX_Z1_AoQ2141  ->Fill(FRS_2141_z, FRS_aoq_2141);
//      h_VFTX_Z1_AoQ2141corr  ->Fill(FRS_2141_z, FRS_aoq_2141_corr);
// //     h_VFTX_beta2241  ->Fill(id_vftx_beta_2241*1000.);
	h_VFTX_AoQ2241   ->Fill(FRS_aoq_2241);
	h_VFTX_AoQ2241corr   ->Fill(FRS_aoq_2241_corr);
// //     h_VFTX_x2AoQ2241  ->Fill(id_vftx_aoq_2241, id_x2);
//      h_VFTX_Z1_AoQ2241  ->Fill(FRS_2241_z, FRS_aoq_2241);
//      h_VFTX_Z1_AoQ2241corr  ->Fill(FRS_2241_z, FRS_aoq_2241_corr);
    }
  }
