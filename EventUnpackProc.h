...
//                 TGo4MbsEvent *fInput;
  ...
  int            scaler_check_first_event = 1;
   ...
   Float_t Music_dE[3], Music_dE_corr[3];
    ...
    Float_t  FRS_vftx_beta_2141;
    Float_t  FRS_gamma_2141;
    Float_t  FRS_aoq_2141;
    Float_t  FRS_aoq_2141_corr;
    Float_t  FRS_2141_z;
    Float_t  FRS_2141_v_cor;
    Float_t  FRS_beta_2241;
    Float_t  FRS_gamma_2241;
    Float_t  FRS_aoq_2241;
    Float_t  FRS_aoq_2241_corr;
    Float_t   FRS_2241_z;
    Float_t  FRS_2241_v_cor;
			TH1* hID_x2;
			TH1* hID_y2;
			TH1* hID_a2;
			TH1* hID_b2;
          ...
          //  TH2I *hID_Z_Z2;
           // TH2I *hID_Z_Z3;
            ...
            TH1* hvftx_ToFraw_2241LL;
            TH1* hvftx_ToFraw_2241RR;
