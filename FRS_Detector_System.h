...
//     Bool_t* b_tpc_de;
  ...
  Float_t       tpc_s4target_y;      /* S4 target y                    */
	...
	Bool_t*       sci_b_veto_e;  
     ...
     //VFTX
  Float_t       vftx_tof2141;
  Float_t       vftx_tof2141_calib;
  Float_t       vftx_tof2241;
  Float_t       vftx_tof2241_calib;
     // MultiHitTDC
  ...
  Float_t       id_vftx_gamma_2141;
  Float_t       id_vftx_delta_2141;
  Float_t       id_vftx_aoq_2141;
  Float_t       id_vftx_aoq_2141_corr;
  Float_t       id_vftx_2141_z;
  Float_t       id_vftx_2141_v_cor;
  Float_t       id_vftx_beta_2241;
  Float_t       id_vftx_gamma_2241;
  Float_t       id_vftx_delta_2241;
  Float_t       id_vftx_aoq_2241;
  Float_t       id_vftx_aoq_2241_corr;
  Float_t       id_vftx_2241_z;
  Float_t       id_vftx_2241_v_cor;
