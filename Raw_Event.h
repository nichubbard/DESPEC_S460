...
private:
    ...
    Float_t ID_vftx_beta_2141; 
    Float_t ID_gamma_2141;
    Float_t ID_aoq_2141;
    Float_t ID_aoq_2141_corr;
    Float_t ID_2141_z;
    Float_t ID_2141_v_cor;
    Float_t ID_beta_2241;
    Float_t ID_gamma_2241;
    Float_t ID_aoq_2241;
    Float_t ID_aoq_2241_corr;
    Float_t ID_2241_z;
    Float_t ID_2241_v_cor;
...
public:
    ...
    void set_DATA_ID_VFTX(Float_t, Float_t,Float_t,Float_t,Float_t,Float_t,Float_t,Float_t,Float_t,Float_t,Float_t,Float_t);
...
// 						  std::vector<double> &VME_TDC_Data,std::vector<double> &VME_TDC_Channels);
    ...
    Float_t get_FRS_vftx_beta_2141(); 
    Float_t get_FRS_gamma_2141();
    Float_t get_FRS_aoq_2141();
    Float_t get_FRS_aoq_2141_corr();
    Float_t get_FRS_2141_z();
    Float_t get_FRS_2141_v_cor();
    Float_t get_FRS_beta_2241();
    Float_t get_FRS_gamma_2241();
    Float_t get_FRS_aoq_2241();
    Float_t get_FRS_aoq_2241_corr();
    Float_t get_FRS_2241_z();
    Float_t get_FRS_2241_v_cor();
